...
if (isset($_SESSION['user_id']) && ($_SESSION['role'] ?? '') === 'student') {
  header('Location: /glosario/alumno/dashboard.php');
  exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (!$email || !filter_var($email, FILTER_VALIDATE_EMAIL) || !$password) {
    ...
    if ($user && $user['role'] === 'student' && password_verify($password, $user['password_hash'])) {
      ...
      $errors[] = 'Credenciales inválidas o cuenta no es de estudiante.';
    }
  }
}
?>
      ...
      <div class="col-12 col-sm-10 col-md-6 col-lg-4">
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <h4 class="text-primary text-center">Portal del Estudiante</h4>
            <p class="text-muted text-center mb-4">Ingresa tus datos para acceder</p>
            ...
            <div class="text-center mt-3">
              <a class="small" href="/glosario/auth/login.php">Acceso de administrador/profesor</a>
            </div>
          </div>
        </div>
      </div>
